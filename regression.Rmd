...
```{r}
library(tableone)
finaltable <- mutate(finaltable, drug = as.factor(drug))
CreateTableOne(vars = c("age", "drug", "gender", "insurance", "mean.pain", "oasis"), strata = "ethnicity", testApprox = chisq.test, data = finaltable)
```
