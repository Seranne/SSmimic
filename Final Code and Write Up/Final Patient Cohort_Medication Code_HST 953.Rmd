...
opioid <- rbind(Fent,Hydrom, Morph, Oxycod, Perco, Hydrocod, Methad)
opioid_nohadmid <-  opioid %>% distinct(hadm_id, .keep_all = TRUE)

# Create .csv file for combined opioid prescriptions
write.csv(opioid, file = "opioid.csv")

# Filter table for only IV drug prescriptions and remove duplicated hadm_ids
...
# Filter table for NO IV drug prescriptions and remove duplicated hadm_id
